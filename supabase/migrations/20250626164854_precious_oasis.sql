-- Update existing integration templates and insert missing ones
-- This avoids foreign key constraint violations by updating existing records

-- First, update existing integration templates that might have changed
UPDATE integration_templates SET
  ...
  config_schema = '{"url": {"type": "string", "required": true}, "method": {"type": "string", "required": true}, "headers": {"type": "object"}, "body": {"type": "string"}}'::jsonb,
  setup_fields = '[
  ...
  examples = '["Fetch weather data from OpenWeatherMap", "Get user information from GitHub API", "Post data to a webhook", "Retrieve cryptocurrency prices"]'::jsonb,
  tags = '["api", "http", "rest", "web", "data"]'::jsonb,
  ...
  version = '1.0.0',
  updated_at = now()
WHERE id = 'http-requests';

-- Insert missing integration templates using INSERT ... ON CONFLICT DO UPDATE
...
(
  ...
  false,
  false,
  '{"url": {"type": "string", "required": true}, "method": {"type": "string", "required": true}, "headers": {"type": "object"}, "body": {"type": "string"}}'::jsonb,
  '[
    {"id": "url", "name": "API URL", "type": "url", "required": true, "placeholder": "https://api.example.com/data", "description": "The URL endpoint to make the request to"},
    {"id": "method", "name": "HTTP Method", "type": "select", "required": true, "options": [{"value": "GET", "label": "GET"}, {"value": "POST", "label": "POST"}, {"value": "PUT", "label": "PUT"}, {"value": "DELETE", "label": "DELETE"}], "defaultValue": "GET", "description": "HTTP method to use for the request"},
    {"id": "headers", "name": "Headers (JSON)", "type": "textarea", "required": false, "placeholder": "{\"Content-Type\": \"application/json\", \"Authorization\": \"Bearer token\"}", "description": "HTTP headers as JSON object", "defaultValue": "{}"},
...
(
  ...
  false,
  false,
  '{"topic": {"type": "string", "required": true}, "country": {"type": "string", "required": true}, "language": {"type": "string", "required": true}}'::jsonb,
  '[
  ...
  '["news", "google", "articles", "current events", "media"]'::jsonb,
  'beginner',
  true,
  true,
  null,
...
(
  ...
  false,
  false,
  '{"feedUrl": {"type": "string", "required": true}, "maxItems": {"type": "number"}}'::jsonb,
  '[
  ...
  '["rss", "feeds", "xml", "syndication", "blogs"]'::jsonb,
  'beginner',
  false,
  true,
  null,
...
(
  ...
  false,
  false,
  '{"dataType": {"type": "string", "required": true}, "symbols": {"type": "string", "required": true}, "currency": {"type": "string", "required": true}}'::jsonb,
  '[
  ...
  '["finance", "crypto", "stocks", "trading", "markets", "prices"]'::jsonb,
  'intermediate',
  true,
  true,
  null,
...
(
  ...
  false,
  true,
  '{"dataType": {"type": "string", "required": true}, "includeContent": {"type": "string"}}'::jsonb,
  '[
  ...
  '["Sync your Notion pages for AI reference", "Monitor database changes automatically", "Access your knowledge base content", "Track project updates from Notion"]'::jsonb,
  '["notion", "oauth", "pages", "databases", "knowledge", "sync"]'::jsonb,
  'intermediate',
  true,
  true,
  'notion',
...
(
  ...
  false,
  false,
  '{"baseUrl": {"type": "string"}, "defaultHeaders": {"type": "object"}, "allowedDomains": {"type": "array"}}'::jsonb,
  '[
  ...
  '["tool", "api", "function", "action", "dynamic", "request"]'::jsonb,
  'advanced',
  true,
  true,
  null,
...
(
  ...
  false,
  false,
  '{"variations": {"type": "array"}, "maxConcurrent": {"type": "number"}}'::jsonb,
  '[
  ...
  '["domain", "availability", "rdap", "registration", "dns", "tool"]'::jsonb,
  'intermediate',
  false,
  true,
  null,
...
(
  ...
  false,
  false,
  '{"webhookUrl": {"type": "string", "required": true}, "zapName": {"type": "string", "required": true}, "description": {"type": "string", "required": true}, "payload": {"type": "object"}, "confirmationMessage": {"type": "string"}, "triggerKeywords": {"type": "array"}}'::jsonb,
  '[
  ...
  '["Send Slack notifications when triggered by AI", "Add new leads to CRM systems automatically", "Create calendar events from voice commands", "Update spreadsheets with AI-generated data", "Trigger email campaigns based on conversations", "Post to social media when specific events occur"]'::jsonb,
  '["zapier", "automation", "webhook", "integration", "workflow", "zap"]'::jsonb,
  'beginner',
  true,
  true,
  'zapier',
...
(
  ...
  false,
  false,
  '{"webhookUrl": {"type": "string", "required": true}, "workflowName": {"type": "string", "required": true}, "description": {"type": "string", "required": true}, "payload": {"type": "object"}, "confirmationMessage": {"type": "string"}, "triggerKeywords": {"type": "array"}}'::jsonb,
  '[
  ...
  '["Process and analyze customer data automatically", "Generate comprehensive reports from multiple data sources", "Sync data between different business systems", "Monitor APIs and send alerts for issues", "Transform and clean data for analysis", "Automate complex multi-step business processes"]'::jsonb,
  '["n8n", "workflow", "automation", "webhook", "integration", "processing"]'::jsonb,
  'intermediate',
  true,
  true,
  'n8n',
...
(
  ...
  false,
  false,
  '{"webhookUrl": {"type": "string", "required": true}, "description": {"type": "string", "required": true}, "payload": {"type": "object"}, "headers": {"type": "object"}, "confirmationMessage": {"type": "string"}, "triggerKeywords": {"type": "array"}}'::jsonb,
  '[
  ...
  '["Activate marketing automation workflows", "Trigger customer onboarding sequences", "Send notifications to external systems", "Start data synchronization processes", "Launch email campaigns or notifications", "Trigger custom business logic and processes"]'::jsonb,
  '["webhook", "automation", "trigger", "custom", "integration", "workflow", "action"]'::jsonb,
  'intermediate',
  false,
  true,
  null,
...
(
  ...
  false,
  false,
  '{"sheetUrl": {"type": "string", "required": true}, "sheetName": {"type": "string", "required": true}, "description": {"type": "string", "required": true}, "defaultSheet": {"type": "string"}, "accessLevel": {"type": "string", "required": true}, "autoSync": {"type": "string"}}'::jsonb,
  '[
  ...
  '["spreadsheet", "data", "google", "sheets", "database", "crm", "crud", "automation"]'::jsonb,
  'beginner',
  true,
  true,
  'google',
...
(
  ...
  false,
  true,
  '{"allowedActions": {"type": "string", "required": true}}'::jsonb,
  '[
  ...
  '["Create a new page in my project database", "Update the status of a task to completed", "Add a new entry to my reading list", "Search for pages containing specific keywords", "Create a meeting notes page with agenda", "Update database properties and values"]'::jsonb,
  '["notion", "oauth", "create", "update", "pages", "databases", "action"]'::jsonb,
  'intermediate',
  true,
  true,
  'notion',
